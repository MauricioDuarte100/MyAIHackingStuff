...
- `regalo.enc.txt`: Contiene el mensaje cifrado en formato hexadecimal: `3e2d2c371760190f1911295d1b130400185236001b1908521c1c`.
...
```python
data = bytes.fromhex('3e2d2c371760190f1911295d1b130400185236001b1908521c1c')
key = b'xampl3'
