...
description: Sub-orquestador especializado en coordinar testing exhaustivo de APIs REST, GraphQL y WebSocket. Coordina api-agent con otros agentes para cobertura completa de APIs.
---
